...
def AppointmentIndex (patient_ID) :
	for i in Doctors_DataBase :
		for j in Doctors_DataBase[i] :							
			if str(patient_ID) == str(j[0]) :
				Index = Doctors_DataBase[i].index(j)
				return Index,i

print("********************************************************************")
print("**                                                                **")
print("**            Welcome to LPU Hospital Management System           **")
print("**                                                                **")
print("********************************************************************")
...
while tries_flag != "Close the program" :
		...
		Patients_DataBase = Read_Hosp.Read_Patients_DataBase()
		Doctors_DataBase  = Read_Hosp.Read_Doctors_DataBase()
		...
		if mode == "1" :																			#Admin mode
				...
				while True :
					...
					if Password == "1234" :
						...
						if AdminOptions == "1" :			#Admin mode --> Patients Management
								...
								print("|To Back enter 0      			|")
								print("-----------------------------------------")
								adminchoice = input ("Enter your choice : ")
																
								if adminchoice == "1" : 						#Admin mode --> Patients Management --> Enter new patient data
								...
								elif adminchoice == "2" :			#Admin mode --> Patients Management --> Display patient data
											try :		#To avoid non integer input
												patient_ID = int(input("Enter patient ID : "))
								...
								elif adminchoice == "3" :				#Admin mode --> Patients Management --> Delete patient data
											try :		#To avoid non integer input
												patient_ID = int(input("Enter patient ID : "))
												while patient_ID not in Patients_DataBase :
													patient_ID = int(input("Incorrect ID, Please Enter patient ID : "))
								...
								elif adminchoice == "4" :						 				#Admin mode --> Pateints Management --> Edit patient data
											try :		#To avoid non integer input
												patient_ID=int(input("Enter patient ID : "))
												while patient_ID not in Patients_DataBase :
													patient_ID = int(input("Incorrect ID, Please Enter patient ID : "))
								...
								elif adminchoice == "0" :		#Admin mode --> Patients Management --> Back
											break
							...
							if adminchoice == "1" : 											#Admin mode --> Doctors Management --> Enter new doctor data
									try :		#To avoid non integer input
							...
							elif adminchoice == "2" : 											#Admin mode --> Doctors Management --> Display doctor data
									try :		#To avoid non integer input
										Doctor_ID = int(input("Enter doctor ID : "))
							...
							elif adminchoice == "3" :											#Admin mode --> Doctors Management --> Delete doctor data
									try :		#To avoid non integer input
										Doctor_ID = int(input("Enter doctor ID : "))
										while Doctor_ID not in Doctors_DataBase :
											Doctor_ID = int(input("Incorrect ID, Please Enter doctor ID : "))
							...
							elif adminchoice == "4" :											#Admin mode --> Doctors Management --> Edit Doctor data
									try :		#To avoid non integer input	
							...
							print("-----------------------------------------")
							adminchoice = input ("Enter your choice : ")
							if adminchoice == "1" :												#Admin mode --> Appointment Management --> Book an appointment							
								try :		#To avoid non integer input
							...
							elif adminchoice == "2" :												#Admin mode --> Appointment Management --> Edit an appointment
									try :		#To avoid non integer input
										patient_ID = int(input("Enter patient ID : "))						
										while patient_ID not in Patients_DataBase :
											patient_ID = int(input("Incorrect Id, Please Enter correct patient ID : "))
										try :   #To avoid no return function
												AppointmentIndex,PairKey = AppointmentIndex(patient_ID)
							...
							elif adminchoice == "3" :												#Admin mode --> Appointment Management --> Cancel an appointment
									try :		#To avoid non integer input
										patient_ID = int(input("Enter patient ID : "))
										while patient_ID not in Patients_DataBase :
					...
					Write_Hosp.Write_Patients_DataBase(Patients_DataBase)
					Write_Hosp.Write_Doctors_DataBase(Doctors_DataBase)
			...
			while True :
				...
				print("|To view patients' residence Enter 3    |")
